...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		serviceBtn = (Button)findViewById(R.id.act_main_service_btn);
		...
		serviceBtn.setOnClickListener(onBtnClickListener);
...
//				//打开服务器通信页面
//				Intent intent = new Intent(getApplicationContext(),BluetoothServiceActivity.class);
